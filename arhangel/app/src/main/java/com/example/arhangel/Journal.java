...
public class Journal extends ListActivity {
    ...
    private static String url_journal = CMN.URL+"journal/get_all_journals.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Journal.LoadDataFormJSON().execute();
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    ...
                    ListAdapter adapter = new SimpleAdapter(
                            ...
                            R.layout.activity_journal_list, new String[] { "id",
                            "begin_date",
                            "end_date",
                            "trener_id"},
